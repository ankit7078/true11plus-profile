...
const Home = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white text-slate-900 font-sans">
                        ...
                        <div className="flex-1 text-center lg:text-left space-y-8">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                                {user ? (
                                    <Link
                                        to="/dashboard"
                                        className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-lg transition-all shadow-lg shadow-blue-200 hover:shadow-xl hover:shadow-blue-300 flex items-center justify-center gap-2"
                                    >
            ...
            {/* --- CTA BOTTOM --- */}
            {/* Switched from dark blue to light blue/indigo to maintain light theme */}
            <section className="bg-indigo-50 py-20 px-4 border-t border-indigo-100">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <button
                        onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
                        className="bg-blue-600 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/30 transform hover:-translate-y-1"
                    >
                        Create Free Account
                    </button>
