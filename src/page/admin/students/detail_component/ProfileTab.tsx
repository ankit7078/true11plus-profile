    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-xs">
          <h4 className="text-xl font-bold text-slate-900 mb-3">About Student</h4>
      ...
      <div className="lg:col-span-1">
        <div className="bg-indigo-900 text-white rounded-xl p-6 shadow-xs h-auto">
          <h4 className="text-xl font-bold mb-2">Mentorship Session</h4>
