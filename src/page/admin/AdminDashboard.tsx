...
const AdminProfilePage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mt-6">
        <div className="relative bg-gradient-to-r from-purple-500 to-purple-600 rounded-md p-6 sm:p-8 mb-6 text-white shadow-md">
          <div className="flex flex-col sm:flex-row sm:items-end gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3">
                ...
                <span className="bg-purple-500/20 text-purple-300 text-xs px-2 py-1 rounded border border-purple-500/30 font-medium flex items-center gap-1">
            ...
            <div className="mt-4 sm:mt-0">
              <Link to="/admin/settings" className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-sm font-medium transition flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-purple-500 rounded-md sticky top-6 p-6 text-white shadow-lg shadow-slate-200/50">
              <div className="flex justify-between items-center mb-6">
                <h4 className="font-semibold flex items-center gap-2">
                  <Activity size={18} className="" /> System Status
                </h4>
                <span className="text-xs bg-purple-500/20 px-2 py-1 rounded border border-purple-500/30">
                  Operational
                </span>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-white">
                <p className="text-xs text-center">Last updated: Just now</p>
              </div>
            </div>
