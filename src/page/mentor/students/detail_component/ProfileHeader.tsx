...
const ProfileHeader: React.FC<Props> = ({ profile }) => {
  return (
    <div className="bg-white rounded-xl p-6 shadow-xs mb-8 flex flex-col md:flex-row items-start md:items-center gap-6">
      <div className="w-20 h-20 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 text-4xl font-bold flex-shrink-0 shadow-inner">
        {profile.initials}
      </div>
      <div className="flex-grow w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
          <div>
            <h4 className="text-xl font-bold text-slate-900 mb-2">{profile.name}</h4>
