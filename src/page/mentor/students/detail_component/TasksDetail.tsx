...
const TaskDetailPage: React.FC = () => {
  ...
  return (
    <div className="text-slate-800">
      ...
      <div className="mb-6">
        <button
          onClick={() => navigate(`/mentor/students/${studentId}/tasks`)}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-500">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-xs">
            <div className="flex justify-between items-start mb-6">
              ...
              <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-md font-bold transition-colors shadow-sm">
                Mark Complete
              </button>
            </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-xs">
            <h4 className="text-lg font-bold text-slate-900 mb-6 uppercase tracking-wider">TASK DETAILS</h4>
